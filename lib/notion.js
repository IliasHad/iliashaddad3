...
const getPageMetaData = async (post) => {
  ...
  let featuredImage
  const slug = post.properties.Slug.rich_text[0] ? post.properties.Slug.rich_text[0].plain_text : null
  ...
  return new Promise((resolve) =>
    resolve({
      id: post.id,
      title: post.properties.Name.title[0] ? post.properties.Name.title[0].plain_text : null,
      ...
      service:
        post.properties.Service && post.properties.Service.select
          ...
          : null,
      client: post.properties.Client && post.properties.Client.rich_text[0]
        ? post.properties.Client.rich_text[0].plain_text
        : null,
      logo,
      service: post.properties.Service && post.properties.Service.rich_text
